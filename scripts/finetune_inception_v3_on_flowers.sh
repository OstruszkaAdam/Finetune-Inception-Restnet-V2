# https://git.mif.vu.lt/TankBusterPBL/TankBuster/blob/b75ff679dd3a23f21786d9b5526b65f9d83ba786/bin/Tensorflow/Tensorflow/slim/scripts/finetune_inception_v3_on_flowers.sh
#!/bin/bash
#
